...
import { copyEmployeeDataToUser } from "./lib/users";
...
// Trigger to create a user profile from the employee list
export const createUserProfile = functions.auth.user().onCreate(copyEmployeeDataToUser);
